...
static inline void lc_fill_gradient(rgb_t *buf, uint16_t start_pos,
                                    hsv_t start_color, uint16_t end_pos,
                                    hsv_t end_color, lc_gradient_dir_t dir) {
...
static inline void lc_fill_gradient3(rgb_t *buf, uint16_t count, hsv_t c1,
                                     hsv_t c2, hsv_t c3,
